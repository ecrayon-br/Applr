...
function smarty_function_PUBLICA_getSectionName($params, &$smarty) {
	global $conexao;
	...
	$strQuery = 'SELECT tb_secao_idioma.bt_nome FROM tb_secao_idioma JOIN tb_secao WHERE tb_secao_idioma.tb_secao_bn_id = tb_secao.bn_id AND tb_secao.bn_id = "' . $params['sectionId'] . '" AND tb_secao_idioma.tb_idioma_bn_id = "' . $params['languageId'] . '";';
