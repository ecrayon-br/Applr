...
function smarty_function_PUBLICA_printBlogTags($params, &$smarty) {
	global $conexao;
	...
	foreach($arrTags AS &$strTag) {
		$strTag = '<a href="'.HTTP_DINAMICO.'/index.php?'.IN_SECAO.'='.$smarty->_tpl_vars['SECAO'].'&'.IB_BUSCA.'=1&'.$params['field'].'='.trim($strTag).'">'.trim($strTag).'</a>';
	}
